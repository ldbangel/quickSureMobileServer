...
<head>
    <meta charset="UTF-8">
    <title>机动车交通事故责任强制保险条款（2008版）</title>
</head>
<style>
    ...
    #LudiDCCTPLClause{max-width:640px;margin:0 auto;text-align:left;}
</style>
<body>
<div id="LudiDCCTPLClause">
<div style="height:auto; font-size: 1rem; line-height: 50px; color:#000; background-color: #fff; text-align: center; padding-right: 10px;">机动车交通事故责任强制保险条款（2008版）</div>

<div style="height:auto; font-size: 1rem; line-height: 50px; color:#000; background-color: #fff; text-align: center; padding-right: 10px;"><a href="" target="_blank" style="font-size: 14px;color: #0000ff"></a></div>
