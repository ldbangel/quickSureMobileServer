...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        ...
        finish: function(e) {
            ...
            var addressDetails=provinceText+","+cityText+","+countyText;
            if(addressDetails!=null&&"undefined"!==typeof(addressDetails)&&""!==addressDetails){
            if(firstscreenFlag!=null&&"undefined"!==typeof(firstscreenFlag)&&firstscreenFlag){
            	setDeptNoandLcnNo(addressDetails,true);
            }else{
            	var Id= _self.trigger.id;
            if("ownersaddress"===Id){
            	$("#ownersaddress").trigger("change");
            }
