DateInput = (function($) {
	...
	DateInput.prototype = {
		...
		dateToString: function(date) {
            if(this.short_month_names[date.getMonth()]<10){return date.getFullYear()+"-"+"0"+this.short_month_names[date.getMonth()]+"-" +this.dateCheck(date)}else{return date.getFullYear()+"-"+this.short_month_names[date.getMonth()]+"-" +this.dateCheck(date)}
		
		},
		dateCheck:function(date){
		 if(date.getDate()>9){return date.getDate()}else{return "0"+date.getDate()}
		},
